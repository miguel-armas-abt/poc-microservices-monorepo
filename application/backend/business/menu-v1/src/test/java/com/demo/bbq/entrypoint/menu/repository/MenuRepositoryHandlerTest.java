...
public class MenuRepositoryHandlerTest {

  @InjectMocks
  private MenuRepositoryHandler menuRepositoryHandler;
  ...
  public void givenTwoSourcesInfo_WhenSearchAllMenuOptions_ThenMapResponse() {
    ...
    String actual = new Gson().toJson(menuRepositoryHandler.findAll(buildHttpServletRequest()));
