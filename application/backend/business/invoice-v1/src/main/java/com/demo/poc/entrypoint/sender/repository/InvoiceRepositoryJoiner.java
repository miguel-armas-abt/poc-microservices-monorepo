package com.demo.poc.entrypoint.sender.repository;

import com.demo.poc.entrypoint.sender.constant.InvoiceConstant;
import com.demo.poc.entrypoint.sender.repository.invoice.InvoiceRepository;
import com.demo.poc.entrypoint.sender.repository.invoice.entity.PaymentStatus;
import com.demo.poc.entrypoint.sender.repository.customer.CustomerRepository;
...
import com.demo.poc.entrypoint.sender.repository.consumption.ConsumptionRepository;
