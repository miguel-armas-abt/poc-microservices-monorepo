package com.demo.bbq.entrypoint.rules.base.util;
...
public class DroolFileGeneratorApplication {
  ...
  public static void main(String[] args) {
    ...
    xlsToDrlUtil.getDLR("C:\\dev-workspace\\bbq-monorepo\\application\\backend\\business\\rules-processor-v1\\src\\main\\resources\\rules\\",
        "discount_rules");
  }
