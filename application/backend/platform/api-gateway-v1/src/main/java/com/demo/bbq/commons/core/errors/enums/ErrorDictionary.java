...
public enum ErrorDictionary {
  ...
  //custom
  ROLE_NOT_FOUND("Expected role not found", "03.00.01"),
  MISSING_AUTHORIZATION_HEADER("Missing Authorization header", "03.00.02"),
  INVALID_AUTHORIZATION_STRUCTURE("Invalid Authorization structure", "03.00.03");
