...
public enum ErrorDictionary {
  ...
  NO_SUCH_REST_CLIENT_ERROR_STRATEGY("03.00.02", "No such rest client error strategy", SYSTEM, INTERNAL_SERVER_ERROR, NoSuchRestClientErrorStrategyException.class),
