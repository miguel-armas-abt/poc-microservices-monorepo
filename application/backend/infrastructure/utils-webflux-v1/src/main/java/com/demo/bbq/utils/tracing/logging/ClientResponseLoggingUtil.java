...
import static com.demo.bbq.utils.tracing.logging.constants.LoggingMessage.HTTP_SUCCESSFUL_RESPONSE;
...
public class ClientResponseLoggingUtil {
    ...
    private static void generateLog(ConfigurationBaseProperties properties,
        ...
        try {
            ...
            var headers = HeaderObfuscatorUtil.process(properties.getObfuscation(), headerObfuscationStrategies, response.headers().asHttpHeaders());
            ...
            log.info(HTTP_SUCCESSFUL_RESPONSE);
