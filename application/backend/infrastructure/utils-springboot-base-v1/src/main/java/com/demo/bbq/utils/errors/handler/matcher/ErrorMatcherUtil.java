package com.demo.bbq.utils.errors.handler.matcher;
...
public class ErrorMatcherUtil {

  public static <T extends Throwable> ErrorDTO replaceWithMatchError(ConfigurationBaseProperties properties, T exception) {
