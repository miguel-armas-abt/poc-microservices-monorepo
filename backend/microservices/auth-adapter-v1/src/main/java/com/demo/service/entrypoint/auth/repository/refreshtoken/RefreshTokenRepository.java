package com.demo.service.entrypoint.auth.repository.refreshtoken;
...
public class RefreshTokenRepository {
  ...
  public RefreshTokenRepository(ApplicationProperties properties,
  ...
  public Mono<TokenResponseWrapper> refreshToken(Map<String, String> headers,
                                                 String refreshToken) {
