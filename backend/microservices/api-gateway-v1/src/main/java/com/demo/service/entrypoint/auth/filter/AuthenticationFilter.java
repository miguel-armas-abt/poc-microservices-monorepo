package com.demo.service.entrypoint.auth.filter;

import com.demo.commons.interceptor.error.ErrorInterceptor;
import com.demo.commons.restserver.utils.RestServerUtils;
import com.demo.service.commons.exceptions.RoleNotFoundException;
import com.demo.service.commons.properties.ApplicationProperties;
import com.demo.service.entrypoint.auth.utils.TokenValidatorUtil;
import com.demo.service.entrypoint.auth.repository.AuthAdapterRepository;
import java.util.*;
