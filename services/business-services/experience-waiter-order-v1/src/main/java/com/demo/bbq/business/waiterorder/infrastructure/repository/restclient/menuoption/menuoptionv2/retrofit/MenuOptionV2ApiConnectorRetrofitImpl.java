package com.demo.bbq.business.waiterorder.infrastructure.repository.restclient.menuoption.menuoptionv2.retrofit;

import java.util.Optional;
import com.demo.bbq.business.waiterorder.domain.exception.WaiterOrderException;
import com.demo.bbq.business.waiterorder.infrastructure.repository.restclient.menuoption.MenuOptionApiConnector;
import com.demo.bbq.business.waiterorder.infrastructure.repository.restclient.menuoption.dto.MenuOptionDto;
import com.demo.bbq.business.waiterorder.infrastructure.repository.restclient.menuoption.dto.MenuOptionRequestDto;
  ...
  public Mono<Void> delete(Long id) {
    return RxJava2Adapter.completableToMono(menuOptionV2Api
        ...
        .onErrorResumeNext(throwable -> Optional.ofNullable(((Exception) throwable).getMessage())
            ...
            .map(error -> Completable.error(WaiterOrderException.ERROR0000.buildException()))
