...
./k8s-db-manifest-builder.sh $DB_RESOURCES_PATH $SECRET_TEMPLATE $TEMPLATES_PATH $DB_SERVICE_TEMPLATE $DB_CONTROLLER_TEMPLATE $K8S_DB_PARAMETERS_CSV $CONTAINERS_CSV $MANIFESTS_PATH