...
if [ "$#" -ne 10 ]; then
    echo "Usage: $0 <RESOURCES_PATH> <SECRET_TEMPLATE> <PV_TEMPLATE> <PVC_TEMPLATE> <TEMPLATES_PATH> <SERVICE_TEMPLATE> <CONTROLLER_TEMPLATE> <K8S_PARAMETERS_CSV> <CONTAINERS_CSV> <MANIFESTS_PATH>"
    exit 1
fi
